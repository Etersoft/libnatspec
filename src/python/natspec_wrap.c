...
/*
 * $Header: /cvsroot/natspec/natspec/src/python/natspec_wrap.c,v 1.5 2006/01/03 01:26:15 vitlav Exp $
 * 
 * swigtcl8.swg
 */
...
#endif
static int
_wrap_natspec_get_current_locale(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *result;
...
static int
_wrap_natspec_get_user_locale(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *result;
...
static int
_wrap_natspec_get_system_locale(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *result;
...
static int
_wrap_natspec_locale_is_utf8(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    int result;
    
    if (SWIG_GetArgs(interp, objc, objv,"s:natspec_locale_is_utf8 locale ",&arg1) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_get_charset(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *result;
...
static int
_wrap_natspec_get_filename_encoding(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"s:natspec_get_filename_encoding locale ",&arg1) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_get_charset_by_locale(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int arg1 ;
    char *arg2 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"is:natspec_get_charset_by_locale type locale ",&arg1,&arg2) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_convert(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    char *arg3 = (char *) 0 ;
    int arg4 ;
    ...
    if (SWIG_GetArgs(interp, objc, objv,"sssi:natspec_convert in_str tocode fromcode transliterate ",&arg1,&arg2,&arg3,&arg4) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_iconv_open(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    iconv_t result;
    
    if (SWIG_GetArgs(interp, objc, objv,"ss:natspec_iconv_open tocode fromcode ",&arg1,&arg2) == TCL_ERROR) SWIG_fail;
    result = natspec_iconv_open((char const *)arg1,(char const *)arg2);
    
    {
        iconv_t * resultptr;
        resultptr = (iconv_t *) malloc(sizeof(iconv_t));
        memmove(resultptr, &result, sizeof(iconv_t));
        Tcl_SetObjResult(interp,SWIG_NewInstanceObj((void*) resultptr, SWIGTYPE_p_iconv_t,1));
    }
    return TCL_OK;
    fail:
    return TCL_ERROR;
...
static int
_wrap_natspec_iconv(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    iconv_t arg1 ;
    char **arg2 = (char **) 0 ;
    ...
    if (SWIG_GetArgs(interp, objc, objv,"oooooi:natspec_iconv cd inbuf inbytesleft outbuf outbytesleft transliterate ",NULL,NULL,NULL,NULL,NULL,&arg6) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &argp1, SWIGTYPE_p_iconv_t,SWIG_POINTER_EXCEPTION ) != TCL_OK)) SWIG_fail;
    arg1 = *argp1; 
    if ((SWIG_ConvertPtr(objv[2], (void **) &arg2, SWIGTYPE_p_p_char,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[3], (void **) &arg3, SWIGTYPE_p_size_t,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[4], (void **) &arg4, SWIGTYPE_p_p_char,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[5], (void **) &arg5, SWIGTYPE_p_size_t,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
...
static int
_wrap_natspec_get_enriched_fs_options(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"ss:natspec_get_enriched_fs_options fs options ",&arg1,&arg2) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_get_codepage_by_charset(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    int result;
    
    if (SWIG_GetArgs(interp, objc, objv,"s:natspec_get_codepage_by_charset cs ",&arg1) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_get_nls_by_charset(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"s:natspec_get_nls_by_charset cs ",&arg1) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_extract_charset_from_locale(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"s:natspec_extract_charset_from_locale locale ",&arg1) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_humble_charset(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"s:natspec_humble_charset charset ",&arg1) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_get_charset_by_charset(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int arg1 ;
    int arg2 ;
    char *arg3 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"iis:natspec_get_charset_by_charset type bytype charset ",&arg1,&arg2,&arg3) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_natspec_convert_with_translit(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    char *arg3 = (char *) 0 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"sss:natspec_convert_with_translit in_str tocode fromcode ",&arg1,&arg2,&arg3) == TCL_ERROR) SWIG_fail;
...
{ SWIG_TCL_INT,     (char *)"NATSPEC_UNIXCS", (long) 0, 0, 0, 0},
{ SWIG_TCL_INT,     (char *)"NATSPEC_WINCS", (long) 1, 0, 0, 0},
{ SWIG_TCL_INT,     (char *)"NATSPEC_DOSCS", (long) 2, 0, 0, 0},
{ SWIG_TCL_INT,     (char *)"NATSPEC_MACCS", (long) 3, 0, 0, 0},
    {0,0,0,0,0,0}
};
